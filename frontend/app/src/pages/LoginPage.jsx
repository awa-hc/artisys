...
export function LoginPage() {
  return (
    ...
    >
      <section className="w-2/3 h-2/3 flex justify-center items-center bg-black/40 rounded-3xl shadow-2xl border-t-[0.5px] border-l-[0.5px] border-white backdrop-blur-lg">
